            ...
            <li class="b_b cl">
                ...
                <div class="ntc_bodys">                       
                    <!--{if $_GET['item'] == 'new' && $task['noperm']}-->
                        <p class="f_a f13">{lang task_group_nopermission}</p>
                    <!--{else}-->
                        <p class="f_a f13">        
                    ...
                    <!--{/if}-->      
                    <!--{if $actives[done]}--><p class="f_d f13">{lang task_complete_on} $task[dateline]</p><!--{else}--><p class="f_d f13">$task[description]</p><!--{/if}-->              
                    <!--{if $_GET['item'] == 'doing'}-->

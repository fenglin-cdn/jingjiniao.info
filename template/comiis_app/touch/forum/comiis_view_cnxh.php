        ...
        <li class="forumlist_li comiis_wzlists bg_f b_b">
          <div class="{if !$comiis_pic_list[$thread_s['tid']]['num']}wzlist_noimg{elseif $comiis_pic_list[$thread_s['tid']]['num'] < 3}wzlist_one{else}wzlist_imgs{/if}">
            ...
            <!--{if $thread_s['attachment'] == 2 && ($comiis_pic_list[$thread_s['tid']]['num'] == 1 || $comiis_pic_list[$thread_s['tid']]['num'] == 2)}-->
              <div class="wzlist_imga"><img {if $comiis_app_switch['comiis_loadimg']}src="https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/pic/none.png" comiis_loadimages={else}src={/if}"{echo getforumimg($comiis_pic_list[$thread_s['tid']]['aid'][0], '0', '200', '160')}"{if $comiis_app_switch['comiis_loadimg']} class="comiis_loadimages"{/if}></div>
            <!--{/if}-->
            <!--{if $thread_s['attachment'] == 2 && $comiis_pic_list[$thread_s['tid']]['num'] >= 3}-->
              ...
              <div class="listimgs">
                ...
                <!--{loop $comiis_pic_list[$thread_s['tid']]['aid'] $temp}-->
                  <li><img {if $comiis_app_switch['comiis_loadimg']}src="https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/pic/none.png" comiis_loadimages={else}src={/if}"{echo getforumimg($temp, '0', '200', '160')}"{if $comiis_app_switch['comiis_loadimg']} class="comiis_loadimages"{/if}></li>
                <!--{/loop}-->
                </ul>
              </div>
            <!--{else}-->

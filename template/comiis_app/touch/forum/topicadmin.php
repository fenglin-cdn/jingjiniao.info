                    ...
                    <!--{if $defaultcheck[recommend] && count($threadlist) == 1}-->
                        ...
                        <li class="tip_txt comiis_flex">
                            ...
                            <div class="flex" style="text-align:left;">
                                <img id="selectimg" src="https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/comiis/img/comiis_none.gif"  width="120" height="80" />
                                ...
                                function updateimginfo(aid) {
                                    if(aid) {
                                        ...
                                        $('#selectimg').attr('src', 'https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/comiis/img/comiis_none.gif');
                                    }
                                }

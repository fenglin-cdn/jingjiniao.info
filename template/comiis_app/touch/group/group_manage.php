...
<div class="comiis_btnbox">
    <button type="submit" class="comiis_btn bg_c f_f" onclick="popup.open('<img src=\'https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/comiis/img/imageloading.gif\' class=\'comiis_loading\'>');">{lang submit}</button>
</div>
</form>
<script>

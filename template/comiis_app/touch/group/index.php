              ...
              <ul>
                ...
                <li class="b_t">
                    <a href="forum.php?mod=forumdisplay&action=list&fid=$fid['fid']" class="block">
                        ...
                        <span class="list01_limg bg_e"><img {if $comiis_app_switch['comiis_loadimg']}src="https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/pic/none.png" comiis_loadimages={else}src={/if}"$fid[icon]" alt="$fid[name]"{if $comiis_app_switch['comiis_loadimg']} class="comiis_loadimages"{/if} /></span>
            ...
            <!--{loop dunserialize($_G['setting']['group_recommend']) $val}-->
                <li class="swiper-slide b_ok">					
                    <a href="forum.php?mod=forumdisplay&action=list&fid={$val['fid']}" title="$val[name]">
                        <img {if $comiis_app_switch['comiis_loadimg']}src="https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/pic/none.png" comiis_loadimages={else}src={/if}"$val[icon]" alt="$val[name]" class="vm{if $comiis_app_switch['comiis_loadimg']} comiis_loadimages{/if}" />						
                        <h2>$val[name]</h2>
                    </a>
...
<!--{/if}-->
{eval}
$comiis_app_wx_share['img'] = 'https://cdn.jsdelivr.net/gh/jingjiniao-info/cdn/template/comiis_app/pic/icon152.png';

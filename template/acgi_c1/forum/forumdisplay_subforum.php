...
<div class="bm bmw fl{if $_G['forum']['forumcolumns']} flg{/if} acpbn">
	<div class="bm_h cl">
		<span class="o"><img id="subforum_{$_G[forum][fid]}_img" src="$_G['style'][styleimgdir]/common//$collapseimg[subforum]" title="{lang spread}" alt="{lang spread}" onclick="toggle_collapse('subforum_$_G['forum'][fid]');" /></span>

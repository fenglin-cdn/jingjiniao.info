...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp wp1240 cl">
		<div id="flk" class="y">
          ...
          <img style="width: 60px; vertical-align: -3px;" src="https://img.202014.xyz/images/2020/01/16/lkmtjs.png">
          <img style="width: 60px; vertical-align: -3px;" src="https://img.202014.xyz/images/2020/01/16/lknvLR.png">
          <img style="width: 60px; vertical-align: -3px;" src="https://img.202014.xyz/images/2020/01/16/lkm0EV.png">
		...
		<div id="frt">
			<p> <strong><a href="" target="_blank">&copy; 2019| 荆棘鸟学园论坛| 网站归属地: 美国加利福尼亚州 </a></strong> <!--{if !empty($_G['setting']['boardlicensed'])}--><!--{/if}--></p>
            <p>荆棘鸟学园论坛是公益性质的TSF交流论坛，完全免费使用，无需任何付费，直到论坛无法承担。</p>
            <p>论坛所有作品都由网友创作上传，不代表网站立场，如有侵犯版权等行为，请来信告知，论坛立即予以处理。</p>
		</div>
		<!--{eval updatesession();}-->

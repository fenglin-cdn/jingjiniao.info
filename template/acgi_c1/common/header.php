...
<!--{subtemplate common/header_common}-->
	...
	<!--{/if}-->
	<script type="text/javascript" src="$_G['style'][styleimgdir]/js/jquery-1.7.1.min.js"></script>
	<!--{if $_G['basescript'] == 'forum' && CURMODULE == 'index' || $_G['basescript'] == 'portal' && CURMODULE == 'index'}-->
		...
		<script type="text/javascript" src="$_G['style'][styleimgdir]/js/modernizr.custom.97074.js?{VERHASH}"></script>
		<script type="text/javascript" src="$_G['style'][styleimgdir]/js/jquery.hoverdir.js?{VERHASH}"></script>
		<script type="text/javascript" src="$_G['style'][styleimgdir]/js/jquery.lazyload.js?{VERHASH}"></script>
...
<body id="nv_{$_G[basescript]}" class="pg_{CURMODULE}{if $_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)} {$cat['bodycss']}{/if}" onkeydown="if(event.keyCode==27) return false;">
	...
	<!--{if empty($topic) || $topic['useheader']}-->
		...
		<div id="toptb">
			...
			<div class="wp cl">
				...
				<div class="y">
					...
					<!--{if check_diy_perm($topic)}-->
					<!--{echo str_replace("title=","c1title=",$diynav);}-->
					<!--{/if}-->
		...
		<div id="hd">
			<div class="wp">
				<div class="hdc cl">
					...
					<h2><!--{if !isset($_G['setting']['navlogos'][$mnid])}--><a href="{if $_G['setting']['domain']['app']['default']}http://{$_G['setting']['domain']['app']['default']}/{else}./{/if}" title="$_G['setting']['bbname']" class="c1logo">{$_G['style']['boardlogo']}</a><!--{else}-->$_G['setting']['navlogos'][$mnid]<!--{/if}--></h2>
					<div class="c1search y">
		...
		<div class="acgic1nvbd">
			<div id="acgic1nv">
				<div class="wp wp1240">
					...
					<ul class="cl">
						<a href="" class="c1nvlogo z"><img src="$_G['style'][styleimgdir]/logo-s.png"/></a>
						<!--{loop $_G['setting']['navs'] $nav}-->
							<!--{if $nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))}-->
							<li <!--{if $mnid == $nav[navid]}class='a' {/if}--><!--{echo str_replace('title=','c1title=',$nav[nav])}-->></li>
						<!--{/if}-->
						<!--{/loop}-->
					</ul>
		...
		<!--{if $_G['setting']['disfixednv_forumindex'] != 1}-->
			<script type="text/javascript">
